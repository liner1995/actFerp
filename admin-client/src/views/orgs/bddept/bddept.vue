...
export default {
  ...
  data() {
    return {
      ...
      top_btn: [
        {name: '录入',code: 'ADD',action: addBdDept}
      ],
      act_btn: [
        {name: '修改',code: 'UPDATE',action: updateBdDeptdoc},
        {name: '删除',code: 'DELETE',action: deleteBdDeptdocByPks}
      ],
      replace: [
        {name: 'canceled',replace: {0:"未封存",1:"已封存"}}
      ]
    }
  },
  methods: {
