...
export default {
  ...
  data() {
    return {
      ...
      top_btn: [
        {name: '录入',code: 'ADD',action: insertMaterielDataBase},
        {name: '导入',code: 'IMPORT',action: null}
      ],
      act_btn: [
        {name: '修改',code: 'UPDATE', action: updateMaterielDataBase, width: 200},
        {name: '删除',code: 'DELETE', action: deleteBdMaterielDataBaseByPks},
      ],
      replace: [
