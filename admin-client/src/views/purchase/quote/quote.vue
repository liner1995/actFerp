...
export default {
  ...
  data() {
    return {
      ...
      act_btn: [
        {name: '报价',code: 'DOQUOTE', when: {'billState': [2]}, action: updatePurchaseQuote},
        {name: '完成报价',code: 'OVERQUOTE', when: {'billState': [2]}, action: updatePurchaseQuote},
        {name: '查看',code: 'LOOKUP', when: {'billState': [0,1,3,6]}, action: updatePurchaseQuote},
        {name: '修订',code: 'REVISE', when: {'billState': [3]}, action: updatePurchaseQuote},
        {name: '物料解析',code: 'MATERIELANALY', when: {'billState': [2, 3]}, action: null}
      ],
      replace: [
