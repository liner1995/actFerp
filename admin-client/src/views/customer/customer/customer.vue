...
export default {
  name: "salecustomer",
  components: { Table, Customercontent },
  data() {
    return {
      content: {
      ...
      top_btn: [
        {name: '录入',code: 'ADD',action: addCustomer}
      ],
      act_btn: [
        {name: '修改',code: 'UPDATE',action: updateCustomer},
        {name: '删除',code: 'DELETE',action: deleteCustomerByPks}
      ],
      replace: [
