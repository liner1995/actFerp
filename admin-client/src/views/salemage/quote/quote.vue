  ...
  data() {
    return {
      ...
      columns: [
        ...
        {prop: 'bomFilename', label: 'BOM文件名称', width: '120'},
        {prop: 'bomFilefullname', label: 'BOM文件全路径名称', width: '120', show: false},
        {prop: 'pcbFilename', label: 'PCB文件名称', width: '120'},
        {prop: 'pcbFilefullname', label: 'PCB文件全路径名称', width: '120', show: false},
        {prop: 'craftFilename', label: '工艺文件名称', width: '120'},
      ...
      act_btn: [
        {name: '报价',code: 'DOQUOTE', when: {'billState': [2]},action: updateSaleQuote, width: 400},
        {name: '完成报价',code: 'OVERQUOTE', when: {'billState': [2]},action: overProccessSaleQupte},
        {name: '查看',code: 'LOOKUP', when: {'billState': [0, 1, 3, 4, 5, 6]},action: updateSaleQuote},
        {name: '重新报价',code: 'REQUOTE', when: {'billState': [6]},action: startRequoteProccess},
        {name: '查看流程',code: 'QUERYFLOW'}
      ],
      replace: [
