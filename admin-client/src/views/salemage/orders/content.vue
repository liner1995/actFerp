<template>
  <el-dialog :title="title" 
      ...
      <el-tabs type="border-card">
        <el-tab-pane label="收货地址">
          <el-form-item label="公司地址" prop="pkTakeover">
            <el-input v-model="temp.pkTakeover" :disabled="true"></el-input>
          </el-form-item>
        </el-tab-pane>
      </el-tabs>
      <br/>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button v-if="title!='查看'" type="primary" @click="passOverOrder">完成订单报价</el-button>
    </span>
...
import { selectTaskoverByPkCustomer, selectProductByPkCustomerAsRef, updateProductOrder } from '@/api/orders/orders'
