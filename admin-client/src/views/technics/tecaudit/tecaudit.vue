  ...
  data() {
    return {
      ...
      top_btn: [
        ...
        {name: '批量通过',code: 'BATCHAPPROVE',action: overTechnicsProccess}
      ],
      act_btn: [
        {name: '查看',code: 'LOOKUP', when: {'technicsState': [22]}, action: updateTecaudit},
        {name: '详情',code: 'CHECK', when: {'technicsState': [21]}, action: updateTecaudit},
        {name: '通过审核',code: 'AUDITPASS', when: {'technicsState': [21]}, action: overTechnicsProccess},
        {name: '物料解析',code: 'MATERIELANALY',action: null}
      ],
      replace: [
