...
public class BdProduct extends PagePoJo implements  Serializable {
    ...
    public Integer getPcbLayer() {
        return pcbLayer;
    }

    public void setPcbLayer(Integer pcbLayer) {
        this.pcbLayer = pcbLayer;
    }
